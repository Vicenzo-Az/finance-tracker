...
export default function Landing() {
  ...
  return (
    <div
      className="min-h-screen text-[#F2F4F0]"
      style={{ fontFamily: "Inter, sans-serif" }}
    >
      {/* Wrapper com overflow-x-hidden apenas no conteúdo, não na raiz (preserva sticky) */}
        ...
        >
          <div className="max-w-5xl mx-auto px-6 md:px-10 pt-16 md:pt-24 pb-20 md:pb-28">
            ...
            >
              ...
              quer entender o próprio dinheiro, não gerenciar uma planilha.
            </motion.p>
          ...
          >
            ...
            <div className="rounded-2xl border border-white/[0.07] bg-[#0F1E18] p-6 md:p-8">
              ...
              <div className="h-36 md:h-44 flex items-end gap-1.5 mb-3">
                {[35, 52, 44, 68, 50, 78, 60, 40, 72, 55, 66, 88].map(
                  (h, i) => (
                    <motion.div
                      key={i}
                      initial={{ scaleY: 0 }}
